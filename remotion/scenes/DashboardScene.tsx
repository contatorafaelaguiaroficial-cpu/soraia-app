...
export const DashboardScene: React.FC = () => {
  ...
  const insightS = spring({ frame: frame - 90, fps, config: { damping: 200 } });
    ...
    <AbsoluteFill>
      ...
      <AbsoluteFill style={{ alignItems: "center", padding: "70px 0 0 0" }}>
        ...
        >
          ...
          <div style={{ fontFamily: fonts.headline, fontSize: 48, color: colors.white, marginTop: 8 }}>
            ELA ANOTA E ANALISA TUDO
          </div>
        </div>

        <PhoneFrame width={720}>
          <AbsoluteFill style={{ background: "#0b0f14", padding: "70px 34px 24px 34px" }}>
            ...
            <CategoryBar label="Lazer" amount="R$ 930" pct={55} color={colors.purpleLight} delay={45} />
